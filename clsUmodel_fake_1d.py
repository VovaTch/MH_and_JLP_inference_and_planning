...
import numpy as np
import gtsam
import joint_lambda_pose_factor_fake_1d
...
class JLPModel:
    ...
    def add_measurements(self, measurement_exp, measurement_cov, new_da_realization, graph, initial, da_realization):
        ...
        for realization in new_da_realization:
            ...
            graph.add(joint_lambda_pose_factor_fake_1d.JLPFactor(self.X(path_length), self.XO(realization),
    ...
    def log_pdf_value(self, measurement_exp, measurement_cov, point_x, point_xo, lambda_prev, lambda_cur):
        ...
        """
        aux_factor = joint_lambda_pose_factor_fake_1d.JLPFactor(1, 2, 3, 4, measurement_exp,
    ...
    def sample_lambda_model(self, chosen_cls, relative_position):
        ...
        if chosen_cls == 1:
            output_list = joint_lambda_pose_factor_fake_1d.AuxOutputsJLP.net_output_1(np.array(relative_position))
        elif chosen_cls == 2:
            output_list = joint_lambda_pose_factor_fake_1d.AuxOutputsJLP.net_output_2(np.array(relative_position))
