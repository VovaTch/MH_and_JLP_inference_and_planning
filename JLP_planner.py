...
class JLPPLannerPrimitives:
    ...
    def __init__(self, JLP_Belief, motion_primitives=None, entropy_lower_limit=None):
    ...
    def planning_session(self, action_noise, geo_noise, horizon=1, ML_planning=True, number_of_samples=10,
