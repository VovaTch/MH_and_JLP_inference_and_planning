...
reward_mode = 2 # 1: Entropy. 2: Expectation Entropy
...
geo_model_noise_diag = np.array([0.00001, 0.00001, 0.00001, 0.0001, 0.0001, 0.00001])
...
# Objects
GT_objects = list()
GT_objects.append(gtsam.Pose3(gtsam.Rot3.Ypr(2.001*math.pi/2, 0.0, 0.0), np.array([5, 0.0, 0.0])))
# GT_objects.append(gtsam.Pose3(gtsam.Rot3.Ypr(math.pi/2, 0.0, 0.0), np.array([3.0, 0.5, 0.0])))
# GT_objects.append(gtsam.Pose3(gtsam.Rot3.Ypr(-math.pi/2, 0.0, 0.0), np.array([3.0, -0.5, 0.0])))
# GT_objects.append(gtsam.Pose3(gtsam.Rot3.Ypr(math.pi/4, 0.0, 0.0), np.array([2.0, 0.5, 0.0])))

# Init poses
Init_poses = list()
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(0.0, 0.0, 0.0), np.array([0.0, 0.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(-np.pi * 1 /4, 0.0, 0.0), np.array([0.5, 2.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(-np.pi * 1 /4, 0.0, 0.0), np.array([1.0, 4.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(-np.pi * 1 /4, 0.0, 0.0), np.array([3.0, 4.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 3 /2, 0.0, 0.0), np.array([5.0, 5.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(-np.pi * 3 /4, 0.0, 0.0), np.array([7.0, 4.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(-np.pi * 3 /4, 0.0, 0.0), np.array([9.0, 4.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(-np.pi * 3 /4, 0.0, 0.0), np.array([9.5, 2.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 2 /2, 0.0, 0.0), np.array([10.0, 0.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 3 /4, 0.0, 0.0), np.array([9.5, -2.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 3 /4, 0.0, 0.0), np.array([9.0, -4.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 3 /4, 0.0, 0.0), np.array([7.0, -4.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 1 /2, 0.0, 0.0), np.array([5.0, -5.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 1 /4, 0.0, 0.0), np.array([3.0, -4.5, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 1 /4, 0.0, 0.0), np.array([1.0, -4.0, 0.0])))
Init_poses.append(gtsam.Pose3(gtsam.Rot3.Ypr(np.pi * 1 /4, 0.0, 0.0), np.array([0.5, -2.5, 0.0])))
...
sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
...
sequence.append(list())
sequence[-1].append(gtsam.Pose3(gtsam.Pose2(0.0, 0.0, 0.0)))
sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
# sequence[-1].append(gtsam.Pose3(gtsam.Pose2(1.0, 0.0, 0.0)))
...
for sequence_idx in range(len(sequence)):
    ...
    plotterdaac2d.GT_plotter_line(GT_sequence, GT_objects, color=(0.8, 0.4, 0.4),
                                  ...
                                  start_pose=GT_sequence[0], robot_id=str(sequence_idx + 1))
...
# INFERENCE
action_noise_diag = np.array([0.0003, 0.0003, 0.0001, 0.0003, 0.00030, 0.00001])
...
for sequence_idx in range(len(sequence)):
    ...
    if Lambda_BSP_mode == 1:
        ...
        reward_list = lambda_planner_list[sequence_idx].evaluate_trajectory(sequence[sequence_idx][1:], action_noise,
                                                                            np.diag(geo_model_noise_diag), ML_planning=False,
