...
class ClsModel:
    ...
    def add_measurement(self, measurement, new_da_realization, graph, initial, da_realization, class_realization):
        ...
        for obj in new_da_realization:
            ...
            graph.add(libNewFactorFake_SP.ClsModelFactor3(self.X(path_length), self.XO(obj),
    ...
    def log_pdf_value(self, measurement, cls, point_x, point_xo):
        ...
        aux_factor = libNewFactorFake_SP.ClsModelFactor3(1, 2, self.ClsModelCore[cls - 1], measurement)
        poses = gtsam.Values()
