...
import cls_un_model_fake_1d_conf
...
class ClsModel:
    ...
    def add_measurement(self, measurement, new_da_realization, graph, initial, da_realization, class_realization):
        ...
        for obj in new_da_realization:
            ...
            graph.add(cls_un_model_fake_1d_conf.ClsUModelFactor(self.X(path_length), self.XO(obj),
    ...
    def log_pdf_value(self, measurement, cls, point_x, point_xo, epsilon = 1e-10):
        ...
        aux_factor = cls_un_model_fake_1d_conf.ClsUModelFactor(1, 2, meas_logit, cls)
    ...
    def model_output(self, pose_x, pose_xo, class_query):
        ...
        if class_query == 1:
            net_prediction = cls_un_model_fake_1d_conf.AuxOutputs.net_output_1(rel_position)
        else:
            net_prediction = cls_un_model_fake_1d_conf.AuxOutputs.net_output_2(rel_position)
