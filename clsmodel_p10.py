...
import libNewFactorFake_p10

class ClsModel:

    def __init__(self):
        # Initializing the classifier models, one per class
        self.ClsModelCore = [libNewFactorFake_p10.ClsModelFake1(), libNewFactorFake_p10.ClsModelFake2()]
    ...
    def add_measurement(self, measurement, new_da_realization, graph, initial, da_realization, class_realization):
        ...
        for realization in new_da_realization:
            ...
            graph.add(libNewFactorFake_p10.ClsModelFactor3(self.X(path_length), self.XO(realization),
    ...
    def log_pdf_value(self, measurement, cls, point_x, point_xo):
        ...
        aux_factor = libNewFactorFake_p10.ClsModelFactor3(1, 2, self.ClsModelCore[cls - 1], measurement)
        poses = gtsam.Values()
